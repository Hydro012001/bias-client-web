    ...
    <div>
      ...
      >
        ...
        <div className=" row ps-4 pt-3 ">
          ...
          <Nav.Link to={"business"} as={NavLink} className="fw-bold text-dark">
            My Business
          </Nav.Link>
          <Nav.Link to={"wallet"} as={NavLink} className="fw-bold text-dark">
            My Wallet
          </Nav.Link>
          <Nav.Link to={"business"} as={NavLink} className="fw-bold text-dark">
            Chat

...
function Newbusiness({ newBusinessList }) {
  ...
  return (
    <div className="mt-2 border">
      <label className="bg-secondary w-100 ps-4 fw-bold ">New Business</label>
      <div className="  pb-4 d-flex  justify-content-evenly  overflow-auto ">
        {newBusinessList.map((item) => (
